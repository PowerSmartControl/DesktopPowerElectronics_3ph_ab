...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module phase_generator_cbkb_rom (
...
initial begin
    $readmemh("./phase_generator_cbkb_rom.dat", ram0);
    $readmemh("./phase_generator_cbkb_rom.dat", ram1);
    $readmemh("./phase_generator_cbkb_rom.dat", ram2);
end
...
phase_generator_cbkb_rom phase_generator_cbkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
