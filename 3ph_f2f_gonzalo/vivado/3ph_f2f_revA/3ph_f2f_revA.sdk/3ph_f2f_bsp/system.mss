...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = current_control
 PARAMETER DRIVER_VER = 1.1
 PARAMETER HW_INSTANCE = current_control_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = FSM_controller
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = fsm_controller_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = phase_generator
 PARAMETER DRIVER_VER = 1.1
 PARAMETER HW_INSTANCE = phase_generator_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = scope_3ph
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = scope_3ph_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = voltage_control
 PARAMETER DRIVER_VER = 1.2
 PARAMETER HW_INSTANCE = voltage_control_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vsi_control
 PARAMETER DRIVER_VER = 2.1
 PARAMETER HW_INSTANCE = vsi_control_0
END
