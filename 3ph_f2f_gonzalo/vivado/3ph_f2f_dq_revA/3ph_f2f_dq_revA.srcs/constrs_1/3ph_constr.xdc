## 3phase Rectifier/Inverter project
## GFB - UC3M
...
set_property IOSTANDARD LVCMOS33 [get_ports {SDATA[4]}]

##IO_L18N_T2_34 JE2
set_property PACKAGE_PIN W16 [get_ports {SDATA[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SDATA[3]}]

##IO_25_35 JE3
set_property PACKAGE_PIN J15 [get_ports {SDATA[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SDATA[2]}]

##IO_L19P_T3_35 JE4
set_property PACKAGE_PIN H15 [get_ports {SDATA[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SDATA[1]}]

##IO_L3N_T0_DQS_34 JE7
set_property PACKAGE_PIN V13 [get_ports {SDATA[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SDATA[6]}]

##IO_L9N_T1_DQS_34 JE8
set_property PACKAGE_PIN U17 [get_ports {SDATA[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SDATA[5]}]

##IO_L20P_T3_34 JE9
set_property PACKAGE_PIN T17 [get_ports {SDATA[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SDATA[7]}]

##IO_L7N_T1_34 JE10
set_property PACKAGE_PIN Y17 [get_ports {SDATA[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SDATA[8]}]
...
##IO_L5N_T0_34 JD2
#set_property PACKAGE_PIN T15 [get_ports {SCLK}]
#set_property IOSTANDARD LVCMOS33 [get_ports {SCLK}]

##IO_L6P_T0_34 JD3
set_property PACKAGE_PIN P14 [get_ports {SDATA[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SDATA[9]}]

##IO_L6N_T0_VREF_34 JD4
#set_property PACKAGE_PIN R14 [get_ports {SD[9]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {SD[9]}]

##IO_L11P_T1_SRCC_34 JD7
set_property PACKAGE_PIN U14 [get_ports nCS]
set_property IOSTANDARD LVCMOS33 [get_ports nCS]

##IO_L11N_T1_SRCC_34 JD8
#set_property PACKAGE_PIN U15 [get_ports {nCS}]
#set_property IOSTANDARD LVCMOS33 [get_ports {nCS}]

##IO_L21P_T3_DQS_34
set_property PACKAGE_PIN V17 [get_ports {SDATA[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SDATA[10]}]

##IO_L21N_T3_DQS_34
#set_property PACKAGE_PIN V18 [get_ports {SD[10]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {SD[10]}]


##Pmod Header JC
##IO_L10P_T1_34 JC1
set_property PACKAGE_PIN V15 [get_ports {S_inv[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S_inv[3]}]

##IO_L10N_T1_34 JC2
set_property PACKAGE_PIN W15 [get_ports {S_inv[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S_inv[4]}]

##IO_L1P_T0_34 JC3
set_property PACKAGE_PIN T11 [get_ports {S_inv[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S_inv[5]}]

##IO_L1N_T0_34 JC4
set_property PACKAGE_PIN T10 [get_ports {S_inv[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S_inv[6]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {S_inv[2]}]

##IO_L2N_T0_34 JC10
set_property PACKAGE_PIN U12 [get_ports {S_inv[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S_inv[1]}]

##Pmod Header JB
##IO_L15P_T2_DQS_34 JB1
set_property PACKAGE_PIN T20 [get_ports {S_rec[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S_rec[1]}]
##IO_L15N_T2_DQS_34 JB2
set_property PACKAGE_PIN U20 [get_ports {S_rec[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S_rec[2]}]

##IO_L16P_T2_34 JB3
set_property PACKAGE_PIN V20 [get_ports {S_rec[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S_rec[5]}]
##IO_L16N_T2_34 JB4
set_property PACKAGE_PIN W20 [get_ports {S_rec[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S_rec[6]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {S_rec[4]}]
##IO_L22N_T3_34 JB10
set_property PACKAGE_PIN W19 [get_ports {S_rec[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {S_rec[3]}]
...
##IO_L24P_T3_34
#set_property PACKAGE_PIN P15 [get_ports ICTRL_ENA]
#set_property IOSTANDARD LVCMOS33 [get_ports ICTRL_ENA]

##IO_L4N_T0_34
#set_property PACKAGE_PIN W13 [get_ports THRDHARM_ENA]
#set_property IOSTANDARD LVCMOS33 [get_ports THRDHARM_ENA]

##IO_L9P_T1_DQS_34
set_property PACKAGE_PIN T16 [get_ports OUT_ENA]
set_property IOSTANDARD LVCMOS33 [get_ports OUT_ENA]
...
##IO_0_35
set_property PACKAGE_PIN G14 [get_ports {LED2[0]}]
