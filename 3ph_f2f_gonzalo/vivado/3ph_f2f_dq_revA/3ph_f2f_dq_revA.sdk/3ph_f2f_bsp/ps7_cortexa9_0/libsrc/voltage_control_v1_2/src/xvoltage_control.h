...
#ifndef XVOLTAGE_CONTROL_H
#define XVOLTAGE_CONTROL_H
...
#ifndef __linux__
#define XVoltage_control_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XVoltage_control_ReadReg(BaseAddress, RegOffset) \
